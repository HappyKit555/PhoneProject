...
public class TelNoteRegex {
        ...
        while(true){
            ...
            if(input.matches(regex)){
                ...
                if(inputNum >= min && inputNum <= max){
                    ...
                    System.out.println("你输入的菜单项不符，请重新输入！");
                }
            }else{
    ...
    public String nameValidate(){
        ...
        while(true){
            ...
            if(input.matches(regex)){
                ...
                System.out.println("你输入的姓名有误，请重新输入！");
            }
        }
    }
    ...
    public String ageValidate(){
        ...
        while(true){
            ...
            if(input.matches(regex)){
                ...
                System.out.println("你输入的年龄格式有误，请重新输入！");
            }
        }
    }
    ...
    public String telNumValidate(){
        ...
        while(true){
            ...
            if(input.matches(regex)){
                ...
                System.out.println("你输入的电话号码格式有误，请重新输入！");
            }
        }
    }
    ...
    public String addressValidate(){
        ...
        Scanner scanner = new Scanner(System.in);
        while(true){
            System.out.println("请输入地址：格式为字母或者数字，长度为1,50");
            String input = scanner.nextLine();
            if(input.matches(regex)){
                return input;
            }else{
